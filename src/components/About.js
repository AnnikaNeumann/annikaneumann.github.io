...
const About = () =>{
    ...
    return(
        ...
        controlling my leg gave me an incredible sense of wonder.</p> 
        <p>The endless possibilities and instant visual changes sparked my interest in frontend development, 
        ...
        I got interested in Scotland, and it wasn't until 2009 that I'd spent my first holidays there and decided to move over with my beloved cats in 2016.</p>
        <p>Ever since, I have worked for the NHS Lothian in administrative roles, which I believe prepared me with excellent interpersonal skills 
        and the ability to work with deadlines and approach problem solving for my future career as a Software Developer.</p>
