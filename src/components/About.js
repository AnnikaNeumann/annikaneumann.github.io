...
const About = () =>{
    ...
    return(
        ...
        <br></br><br></br>I was born in Germany and lived in the beautiful Black Forest region, which (prepare yourself for a fun fact!) is known for the World's largest Cuckoo Clock and the Black Forest Gateau! For the past 20 years, I have worked in different roles within the health sector in Germany and Switzerland. 
        These provided me with excellent interpersonal skills and the discipline to work within deadlines. These roles also required creative thinking and quick problem-solving. <br></br><br></br>However, I always knew that I wanted to live in other places, and so Ireland became my home from 2006-to 2007.
        I got interested in Scotland, and it wasn't until 2009 that I'd spent my first holidays there and decided to move over with my beloved cats in 2016.  <br></br><br></br>Ever since, I have worked for the NHS Lothian in administrative roles, which I believe prepared me with excellent interpersonal skills 
