      ...
      <div className='button-container'>
        ...
        <div className='social-links'>
          ...
          <a href="https://www.linkedin.com/in/annika-neumann-422b98232/" tabIndex='0' target="_blank" rel="noreferrer"><img src={require("../images/linkedin.png")} alt='Link to LinkedIn'/></a>
            ...
            //   <a href="https://github.com/AnnikaNeumann" tabIndex='0' target="_blank" rel="noreferrer"><img src={require("../images/github-sign.png")} alt='Link to Github'/>
            //   </a>
            //   </div>
            //   <div className='item-3'>
            //   <a href="https://www.linkedin.com/in/annika-neumann-422b98232/" tabIndex='0' target="_blank" rel="noreferrer"><img src={require("../images/linkedin.png")} alt='Link to LinkedIn'/>
            //   </a>
            //   </div>
            //   </div>
